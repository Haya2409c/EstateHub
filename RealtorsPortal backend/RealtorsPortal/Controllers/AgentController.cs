...
namespace RealtorsPortal.Controllers
{
    ...
    public class AgentController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ViewBag.ActiveListings   = allProps.Count(p => p.Status != null);
        ...
        public async Task<IActionResult> CreateListing(CreateListingViewModel model)
        {
            ...
            var categoryName = model.PropertyType.ToLower() switch
            {
                "house"      => "House",
                "apartment"  => "Apartment",
                "plot"       => "Plot",
            ...
            var category = await _db.Categories.FirstOrDefaultAsync(c => c.Name == categoryName)
                           ?? await _db.Categories.FirstAsync();
        ...
        public async Task<IActionResult> DeleteImage(int imageId, int? listingId)
        {
            ...
            var image = await _db.PropertyImages
                ...
                .FirstOrDefaultAsync(i => i.Id == imageId && i.Property.SellerId == userId);
